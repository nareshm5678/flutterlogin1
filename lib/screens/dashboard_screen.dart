...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _showProfileEditDialog() async {
    ...
    final parentNameController = TextEditingController(text: widget.user.parentName);
    final mobileController = TextEditingController(text: widget.user.userMobile);
    final addressController = TextEditingController(text: widget.user.userAddress);
    final bgController = TextEditingController(text: widget.user.userBg);
    final ageController = TextEditingController(text: widget.user.userAge.toString());
    final genderController = TextEditingController(text: widget.user.userGender);
                  ...
                  onPressed: () async {
                    final confirm = await showDialog<bool>(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        content: Text('Are you sure you want to clear this field?'),
                        actions: [
                          TextButton(
